...
```{r, code=readLines("summary.R"), echo=FALSE}
```
...
Through the years of 2018 to 2022, there has been a steady decrease in the amount of physical books that have been checked out from the Seattle Public Library. In 2018, `num_physical_checkouts_2018` were checked out. In 2019, `num_physical_checkouts_2019` were checked out. In 2020, when thew coronavirus pandemic first began, `num_physical_checkouts_2020` were checked out. During the peak years of the pandemic, there were `num_physical_checkouts_2021` in 2021, and `num_physical_checkouts_2022`. Based on the data collected, there is clearly indication of a decrease in the number of books checked out, during the peak years of the Coronavirus pandemic.
